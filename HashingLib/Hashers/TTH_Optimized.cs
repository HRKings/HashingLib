...
namespace HashingLib.Hashers
{
    /// <summary>
    /// A more optmized implementation of TTH
    /// </summary>
    internal class TTH_Optimized
    {
        private const int ZERO_BYTE_FILE = 0;    //file with no data.
        private const int Block_Size = 64;   //64k
        private const int Leaf_Size = 1024; //1k - don't change this.
        ...
        private static byte[] CompressHashBlock(byte[][] HashBlock, int HashCount) //compresses hash blocks to hash.
        {
        ...
        private static byte[] ByteExtract(byte[] Raw_Data, int Data_Length) //if we use the extra 0x00 in Raw_Data we will get wrong hash.
        {
