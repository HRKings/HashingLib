...
namespace HashingLib.Utils
{
    ...
    /// </summary>
    internal class HashStringConverter
    {
        ...
        /// <summary>
        /// Simple method to convert a MD5 hash to a string
        /// </summary>
        /// <param name="hashBytes">The array containing the MD5 hash</param>
        /// <returns>The string with the hash</returns>
        public static string MD5HashStringBuilder(byte[] hashBytes)
        {
